...
export default function Signup() {
  ...
  // note that confirm does not work if you reload the page after signup. You can fix this with more changes.
  // see the chapter for details: https://serverless-stack.com/chapters/signup-with-aws-cognito.html
